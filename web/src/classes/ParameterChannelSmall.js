...
class ParameterChannelSmall {
  ...
  updateSize (width, height) {
    ...
    this.styleLabel.fontSize = parseInt(this.fontSizeLabel / this.fontFactorLabel)
    this.styleValue.fontSize = parseInt(this.fontSizeValue / this.fontFactorValue)
    this.styleAlarm.fontSize = parseInt(this.fontSizeAlarms / this.fontFactorAlarms)
