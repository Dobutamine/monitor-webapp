  ...
  <q-dialog v-model="confirm" ref="dialog" persistent buttons>
       <q-card class="q-ma-sm" style="width: 250px">
                        ...
                        <q-card-section align="center">
                              <q-select v-model="selectedLabTest" :options="labTestList" style="max-width: 300px" stack-label label="chest compressions pattern" />
                        </q-card-section>
...
export default {
  ...
  data() {
    return {
      ...
      labTestList: ['bloodgas', 'electrolytes', 'complete blood count', 'inflammation markers','metabolic']
