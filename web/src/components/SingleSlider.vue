<template>
    <q-card class="q-pa-sm" bordered>
        <div class="row">
            <q-btn class="q-ma-sm col" :color="buttonColorEnabled" size=sm @click="showPopUp">
                    {{ label }}
            </q-btn>
        </div>
...
export default {
    ...
    data () {
        return {
            ...
            timeLeft: 0,
            stepSize: 0,
            timeInOptions: ['instant', '5 sec', '10 sec', '15 sec', '20 sec', '30 sec', '1 min', '2 min', '3 min'],
            timeInOption: 'instant',
            timeAtOptions: ['instant', '5 sec', '10 sec', '15 sec', '20 sec', '30 sec', '1 min', '2 min', '3 min'],
    ...
    methods: {
        showPopUp () {
            this.$q.dialog({ component: ChannelSettings, parent: this, channel: null})
        },
        changeTimeIn (e) {
            console.log(e)
        ...
        changeTargetValue () {
            ...
            if (this.targetValue != this.currentValue) {
                if (this.timeInOption != 'instant') {
                    ...
                    this.armed = true
                    this.currentValueText = (this.currentValue).toFixed(1) + ' -> ' + this.targetValue
                } else {
